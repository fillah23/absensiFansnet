<div id="sidebar" class="active">
    <div class="sidebar-wrapper active">
        <div class="sidebar-header position-relative">
            <div class="d-flex justify-content-between align-items-center">
                <div class="logo px-3 mt-1">
                    <a href="/dashboard" style="text-decoration: none;">
                        <h4 class="text-primary fw-bold mb-0">Absensi FansNet</h4>
                    </a>
                    <!-- Jam & Tanggal Simple -->
                    <small class="text-muted d-block mt-1" style="font-size: 0.7rem;">
                        <div id="sidebarTime" class="fw-bold">00:00 WIB</div>
                        <div id="sidebarDate">Loading...</div>
                    </small>
                </div>
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item {{ Request::is('absensi/daftar*') ? 'active' : '' }}">
                    <a href="{{ route('absensi.daftar') }}" class='sidebar-link'>
    ...
    <script>
        // Update Jam & Tanggal Sidebar Simple - WIB
        function updateSidebarClock() {
            ...
            document.getElementById('sidebarTime').textContent = timeStr + ' WIB';
            document.getElementById('sidebarDate').textContent = dateStr;
        }
        
        updateSidebarClock();
        setInterval(updateSidebarClock, 60000); // Update tiap 1 menit
